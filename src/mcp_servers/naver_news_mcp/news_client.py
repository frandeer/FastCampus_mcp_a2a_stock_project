...
from src.mcp_servers.common.clients.base_client import BaseHTTPClient
...
class NewsClient(BaseHTTPClient):
    ...
    async def search_news(
        ...
        try:
            ...
            # logger.info(f"네이버 뉴스 검색 결과: {result}")
            ...
            for query in search_queries:
                try:
                    ...
                    for item in news_items:
                        ...
                        # if (
                        #     is_stock_related
                        #     or symbol.lower() in title
                        #     or (company_name and company_name.lower() in title)
                        # ):
